...
export const defaultVideoProps: VideoProps = {
  ...
  scenes: [
    ...
    { text: "Sounds Packs Effects Tutorials Apps Plugins And More...", fontSize: 150, layout: 9 },
    { text: "Right Here Right Now", fontSize: 150, layout: 10 },
    { text: "", fontSize: 80, layout: 13 },
  ],
};
